...
class LikedAdapter @Inject constructor(
    ...
    private val diffCallback= object : DiffUtil.ItemCallback<YTVideoLinkLiked>(){
        override fun areItemsTheSame(oldItem: YTVideoLinkLiked, newItem: YTVideoLinkLiked): Boolean {
            return oldItem.videoId == newItem.videoId
        }

        override fun areContentsTheSame(oldItem: YTVideoLinkLiked, newItem: YTVideoLinkLiked): Boolean {
